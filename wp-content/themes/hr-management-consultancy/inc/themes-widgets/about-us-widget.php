...
class HR_Management_Consultancy_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'HR_Management_Consultancy_About_Widget',
			__('VW About us', 'hr-management-consultancy'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'hr-management-consultancy' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','hr-management-consultancy'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','hr-management-consultancy'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','hr-management-consultancy'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','hr-management-consultancy'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','hr-management-consultancy'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','hr-management-consultancy'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function hr_management_consultancy_about_custom_load_widget() {
	register_widget( 'HR_Management_Consultancy_About_Widget' );
}
add_action( 'widgets_init', 'hr_management_consultancy_about_custom_load_widget' );