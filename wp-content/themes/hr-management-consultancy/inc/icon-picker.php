...
class HR_Management_Consultancy_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'hr-management-consultancy' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $hr_management_consultancy_font_awesome_icon_array = hr_management_consultancy_font_awesome_icon_array();
                    foreach ($hr_management_consultancy_font_awesome_icon_array as $hr_management_consultancy_font_awesome_icon) {
                            $icon_class = $this->value() == $hr_management_consultancy_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($hr_management_consultancy_font_awesome_icon).'"></i>
                            <span class="hr-management-consultancy-social-class">'.esc_attr($hr_management_consultancy_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function hr_management_consultancy_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'hr-management-consultancy-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'hr_management_consultancy_customizer_script' );

if(!function_exists('hr_management_consultancy_font_awesome_icon_array')){
    function hr_management_consultancy_font_awesome_icon_array(){
