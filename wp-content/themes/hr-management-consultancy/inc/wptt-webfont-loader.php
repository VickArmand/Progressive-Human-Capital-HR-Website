...
if ( ! class_exists( 'HR_Management_Consultancy_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class HR_Management_Consultancy_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new HR_Management_Consultancy_WPTT_WebFont_Loader( $url );
